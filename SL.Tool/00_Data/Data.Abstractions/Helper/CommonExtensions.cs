...
namespace Data.Abstractions.Helper
{
    ...
    public static class CommonExtensions
    {
        ...
        #region 集合判断非空
        public static bool IsListNull<T>(this List<T> s)
        {
            if (s == null || s.Count == 0)
            {
                return true;
        ...
        public static bool NotListNull<T>(this List<T> s)
        {
            if (s == null || s.Count == 0)
            {
                return false;
        ...
        #region gui取最后8位
        public static string To8Length(this string str, int length = 8)
        {
            return str.Substring(str.Length - length, length);
        }
        #endregion

        public static bool IsGNull(this Guid? id)
        {
        ...
        public static bool NotGNull(this Guid? id)
        {
            if (id.HasValue && id.Value != Guid.Empty)
            {
                return true;
